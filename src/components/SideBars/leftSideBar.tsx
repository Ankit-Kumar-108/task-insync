    ...
    <div className="w-64 min-h-screen p-4 border-r border-white/20 pt-20 flex flex-col justify-start items-center fixed z-40 bg-[#101922]">
      ...
      <div className="flex justify-between items-center flex-col">
        <button className="flex justify-start items-center p-2 gap-3 w-56 hover:bg-white/5 rounded-lg transition-all duration-200 group">
          ...
          <p className="opacity-0 group-hover:opacity-100 duration-200 transition-all font-bold ml-auto">...</p>
        </button>
        <button className="flex justify-start items-center p-2 gap-3 w-56 hover:bg-white/5 rounded-lg transition-all duration-200 group">
      ...
      <div className="w-53 h-24 bg-[#1c2127] rounded-xl border border-white/15 flex flex-col justify-center items-center gap-2 absolute bottom-10">
        ...
        <div className="h-2 w-[80%] bg-white/20 rounded-full overflow-hidden">
          <div
        ...
        <div className="">
          <span className="opacity-40 text-xs text-center block">
